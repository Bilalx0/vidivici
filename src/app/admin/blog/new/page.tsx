    ...
    <div>
      ...
      <form onSubmit={async (e) => { e.preventDefault(); setSubmitting(true); /* API call */ router.push("/admin/blog") }} className="max-w-3xl space-y-4">
        ...
        <div>
          ...
          <input type="file" accept="image/*" className="text-sm text-mist-400 file:mr-4 file:py-2 file:px-4 file:rounded file:border-0 file:text-sm file:font-semibold file:bg-[#dbb241] file:text-black" />
        </div>
