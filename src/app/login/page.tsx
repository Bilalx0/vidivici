        ...
        <div className="w-full max-w-[460px] 2xl:max-w-[600px]">
          <div className="bg-white rounded-2xl 2xl:rounded-3xl shadow-xl border border-mist-200 px-8 2xl:px-12 py-10 2xl:py-16 sm:px-10 sm:py-12">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2.5 border border-mist-200 bg-mist-50 rounded-lg 2xl:rounded-xl py-3 2xl:py-4 text-sm 2xl:text-base text-mist-600 hover:bg-mist-100 transition-colors"
            >
