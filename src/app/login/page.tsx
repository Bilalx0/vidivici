    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4 pt-20 pb-10">
      <div className="w-full max-w-[440px]">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 sm:p-10">
          <div className="mb-8">
            <h1 className="text-2xl font-bold text-mist-900">Welcome Back</h1>
            <p className="text-sm text-mist-500 mt-1">Log in to your Vidi Vici account</p>
          </div>
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                <input type="checkbox" checked={remember} onChange={(e) => setRemember(e.target.checked)}
                  className="w-4 h-4 border-gray-300 rounded text-mist-900 focus:ring-gray-900" />
                <span className="text-sm text-mist-600">Remember me</span>
              </label>
              <span className="text-sm text-mist-500 cursor-pointer hover:text-mist-900">Forgot password</span>
            </div>
          ...
          <p className="text-center text-sm text-mist-500 mt-6">
            ...
            <Link href="/register" className="text-mist-900 font-semibold hover:underline">Sign up</Link>
          </p>
        </div>
      </div>
    </div>
