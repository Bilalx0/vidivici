...
export default function AirportTransferPage() {
  return (
    <div>
      <Banner
        heading="Arrive in Style and Comfort with Luxury Airport Transfers"
  ...
  <div className="flex-1 max-w-3xl">
    <h2 className="text-3xl sm:text-4xl 2xl:text-6xl font-bold text-mist-900 leading-tight mb-4 2xl:mb-6">
      Luxury Airport Transfers in Los Angeles
    </h2>
    <p className="text-mist-500 text-sm sm:text-base 2xl:text-2xl leading-relaxed mb-4 2xl:mb-6">
      Make every arrival and departure an unforgettable experience.
    </p>
    <p className="text-mist-500 text-sm sm:text-base 2xl:text-2xl leading-relaxed mb-4 2xl:mb-6">
      Whether you're flying into LAX, Burbank, or John Wayne Airport — Vidi Vici delivers the perfect combination of comfort, punctuality, and style.
    </p>
    <p className="text-mist-500 text-sm sm:text-base 2xl:text-2xl leading-relaxed">
      From executive sedans to luxury SUVs, our handpicked fleet ensures you travel with confidence and class — wherever your journey takes you.
    </p>
