...
export default function WeddingCarRentalPage() {
  return (
    <div>
      <Banner
        heading="Wedding Luxury Car Rental: Arrive in Style"
  ...
  <div className="flex-1 max-w-3xl">
    <h2 className="text-3xl sm:text-4xl 2xl:text-6xl font-bold text-mist-900 leading-tight mb-4 2xl:mb-6">
      Wedding Luxury Car Rental in Los Angeles
    </h2>
    ...
    <p className="text-mist-500 text-sm sm:text-base 2xl:text-2xl leading-relaxed mb-4 2xl:mb-6">
      Whether you're the bride, groom, or attending a wedding celebration — Vidi Vici delivers the perfect combination of elegance, comfort, and style.
    </p>
    <p className="text-mist-500 text-sm sm:text-base 2xl:text-2xl leading-relaxed">
      From classic luxury sedans to elegant convertibles and SUVs, our handpicked fleet ensures you arrive with confidence and class — wherever your wedding takes you.
    </p>
