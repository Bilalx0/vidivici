                ...
                events.map((event) => {
                  ...
                  return (
                    <tr key={event.id} className="border-b border-mist-100 hover:bg-mist-50 transition-colors">
                      ...
                      <td className="px-6 py-4 text-sm text-mist-500">{event.location}</td>
                      <td className="px-6 py-4 text-sm text-mist-500">{event.category}</td>
                      <td className="px-6 py-4 text-sm text-mist-500">{event.capacity}</td>
                      <td className="px-6 py-4">
