      ...
      <div className="w-full max-w-[440px]">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 sm:p-10">
          <div className="mb-8">
            ...
            <p className="text-sm text-gray-500 mt-1">Log in to your Vidi Vici account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="text-sm text-gray-500 cursor-pointer hover:text-gray-900">Forgot password</span>
            </div>
          ...
          <p className="text-center text-sm text-gray-500 mt-6">
            ...
            <Link href="/register" className="text-gray-900 font-semibold hover:underline">Sign up</Link>
          </p>
        </div>
      </div>
    </div>
