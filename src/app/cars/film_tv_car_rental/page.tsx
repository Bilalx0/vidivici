...
export default function FilmTvCarRentalPage() {
  return (
    <div>
      <Banner
        heading="Film & TV Production Car Rental Los Angeles"
  ...
  <div className="flex-1 max-w-3xl">
    <h2 className="text-3xl sm:text-4xl 2xl:text-6xl font-bold text-mist-900 leading-tight mb-4 2xl:mb-6">
      Film & TV Production Car Rentals in Los Angeles
    </h2>
    <p className="text-mist-500 text-sm sm:text-base 2xl:text-2xl leading-relaxed mb-4 2xl:mb-6">
      Make every scene an unforgettable experience.
    </p>
    <p className="text-mist-500 text-sm sm:text-base 2xl:text-2xl leading-relaxed mb-4 2xl:mb-6">
      Whether you're filming a blockbuster movie, commercial, or TV show — Vidi Vici delivers the perfect combination of performance, comfort, and style.
    </p>
    <p className="text-mist-500 text-sm sm:text-base 2xl:text-2xl leading-relaxed">
      From sleek supercars to ultra-luxury sedans and SUVs, our handpicked fleet ensures your production looks authentic and impressive — wherever filming takes you.
    </p>
