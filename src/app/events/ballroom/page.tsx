...
function BallroomPayPalButton({ bookingData, onSuccess, onError }: {
        ...
        createOrder={async () => {
          ...
          try {
            const res = await fetch("/api/paypal/create-order", {
              ...
              body: JSON.stringify({ totalPrice: 100, currency: "USD", bookingRef: "ballroom-event", intent: "CAPTURE" }),
            })
