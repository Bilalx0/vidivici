    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center text-center px-6 max-w-3xl mx-auto mt-20">
          ...
          {/* Heading */}
          <h1 className="hero-title text-white font-bold mb-5 text-3xl sm:text-5xl leading-snug">
            Experience Luxury Like Never Before with Vidi Vici
          </h1>

          {/* Subheading */}
          <p className="hero-sub text-white/75 font-extralight leading-relaxed mb-10 text-base sm:text-xl px-0 sm:px-8">
          ...
          <div className="hero-search w-full max-w-lg">
            <div
              className="flex items-center gap-3 px-5 py-3 rounded-2xl border border-white/40 transition-all duration-300 focus-within:border-white/60"
              style={{
