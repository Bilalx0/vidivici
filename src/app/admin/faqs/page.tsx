      ...
      {showForm && (
        <div className="bg-white border border-gray-200 rounded-xl p-6 mb-6 space-y-4">
          <div>
            ...
            <input type="text" className="w-full bg-gray-50 border border-gray-200 text-mist-900 text-sm px-4 py-3 rounded focus:border-black focus:outline-none" />
          </div>
          <div>
            <label className="text-xs text-mist-500 block mb-1">Answer</label>
            <textarea rows={4} className="w-full bg-gray-50 border border-gray-200 text-mist-900 text-sm px-4 py-3 rounded focus:border-black focus:outline-none resize-none" />
          </div>
          <div>
            <label className="text-xs text-mist-500 block mb-1">Order</label>
            <input type="number" className="w-32 bg-gray-50 border border-gray-200 text-mist-900 text-sm px-4 py-3 rounded focus:border-black focus:outline-none" />
          </div>
