        ...
        <div className="border border-mist-200 rounded-3xl 2xl:rounded-[40px] overflow-hidden gap-8 2xl:gap-14 sm:p-8 2xl:sm:p-16 px-4 py-6 2xl:px-8 2xl:py-12 flex flex-col md:flex-row shadow-sm">
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-col gap-6 2xl:gap-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 2xl:gap-8">
                <div className="flex flex-col gap-2 2xl:gap-4">
                  <label className="text-xs 2xl:text-sm font-semibold text-mist-700 uppercase tracking-wide">Event Type</label>
                  <div className="relative">
                    <select value={form.eventType} onChange={(e) => setForm({ ...form, eventType: e.target.value })}
                      className="w-full border border-mist-300 rounded-xl 2xl:rounded-2xl px-4 py-3 pr-12 2xl:px-6 2xl:pr-14 2xl:py-5 text-sm 2xl:text-xl text-mist-900 bg-white focus:outline-none focus:border-mist-400 transition-colors duration-200 cursor-pointer appearance-none">
                ...
                <div className="flex flex-col gap-2 2xl:gap-4">
                  <label className="text-xs 2xl:text-sm font-semibold text-mist-700 uppercase tracking-wide">Event Date</label>
              ...
              {/* Guest Count */}
              <div className="flex flex-col gap-2 2xl:gap-4">
                <label className="text-xs 2xl:text-sm font-semibold text-mist-700 uppercase tracking-wide">Number of Guests</label>
              ...
              {/* Add-Ons */}
              <div className="flex flex-col gap-2 2xl:gap-4">
                <label className="text-xs 2xl:text-sm font-semibold text-mist-700 uppercase tracking-wide">Add-Ons</label>
                <div className="flex flex-wrap gap-3 2xl:gap-6">
                  {ADD_ONS.map((addon) => (
                    <button type="button" key={addon} onClick={() => toggleAddOn(addon)} className="flex items-center gap-2 cursor-pointer">
                      <div className={`w-4 h-4 2xl:w-5 2xl:h-5 rounded-full border-2 flex items-center justify-center transition-colors ${
                        form.addOns.includes(addon) ? "border-blue-600" : "border-mist-300"
                      }`}>
                        {form.addOns.includes(addon) && <div className="w-2 h-2 2xl:w-2.5 2xl:h-2.5 rounded-full bg-blue-600" />}
                      </div>
                      <span className="text-sm 2xl:text-xl text-mist-600">{addon}</span>
                    </button>
                  ))}
                </div>
              </div>
              ...
              <button onClick={handleSubmit}
                className="w-full bg-mist-900 text-white cursor-pointer font-semibold py-4 2xl:py-6 rounded-xl 2xl:rounded-2xl hover:bg-mist-800 transition-colors duration-200 mt-2 disabled:opacity-40 disabled:cursor-not-allowed"
  ...
  return (
    ...
    <div className="relative flex flex-col bg-white rounded-3xl 2xl:rounded-3xl overflow-hidden shadow-sm hover:shadow-md transition-all duration-300  flex-shrink-0 group cursor-pointer">
      ...
      <div className="flex flex-col gap-2 2xl:gap-4 px-6 2xl:px-8 pt-3.5 2xl:pt-5 pb-4 2xl:pb-6">
        ...
        {/* Stats Row - Using vertical dividers slightly decreased for 2xl */}
        ...
        <div className="flex items-center justify-between mt-0.5 2xl:mt-0">
          ...
          <div className="flex flex-col items-end">
            ...
            <span className="text-[10px] 2xl:text-sm text-mist-400">
              <span className="line-through">${villa.pricePerNight.toLocaleString()}</span> / night
            </span>
          </div>
        </div>
      </div>
...
<section className="sm:px-16 lg:px-20 2xl:px-32 px-6 mt-24 2xl:mt-48">
  <div className="">
    <h2 className="text-3xl sm:text-4xl 2xl:text-6xl font-bold text-mist-900 text-center my-20 2xl:my-40">
        ...
        <div className="">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-4 2xl:gap-y-8 gap-x-6 2xl:gap-x-10">
            ...
            <div className="flex items-center gap-4 2xl:gap-8 bg-mist-100 rounded-3xl p-4 2xl:p-8">
              ...
              />
              <div className="pt-1">
                <h3 className="text-base 2xl:text-[26px] font-bold text-mist-900 mb-1 2xl:mb-3">Mixologist</h3>
            ...
            <div className="flex items-center gap-4 2xl:gap-8 bg-mist-100 rounded-3xl p-4 2xl:p-8">
              ...
              />
              <div className="pt-1">
                <h3 className="text-base 2xl:text-[26px] font-bold text-mist-900 mb-1 2xl:mb-3">Valet Parking</h3>
                <p className="text-base 2xl:text-2xl text-mist-500 font-normal leading-relaxed">
            ...
            <div className="flex items-center gap-4 2xl:gap-8 bg-mist-100 rounded-3xl p-4 2xl:p-8">
              ...
              />
              <div className="pt-1">
                <h3 className="text-base 2xl:text-[26px] font-bold text-mist-900 mb-1 2xl:mb-3">Driver</h3>
                <p className="text-base 2xl:text-2xl text-mist-500 font-normal leading-relaxed">
            ...
            <div className="flex items-center gap-4 2xl:gap-8 bg-mist-100 rounded-3xl p-4 2xl:p-8">
              ...
              />
              <div className="pt-1">
                <h3 className="text-base 2xl:text-[26px] font-bold text-mist-900 mb-1 2xl:mb-3">Security Team</h3>
                <p className="text-base 2xl:text-2xl text-mist-500 font-normal leading-relaxed">
      ...
      <section className="px-6 sm:px-16 lg:px-20 2xl:px-32 mt-24 2xl:mt-48">
        <div className="">
          <div className="relative bg-mist-100 rounded-3xl 2xl:rounded-[40px] px-8 2xl:px-16 py-16 2xl:py-24 text-center overflow-hidden">
            ...
            <p className="text-sm 2xl:text-2xl text-mist-500 max-w-sm 2xl:max-w-lg mx-auto leading-relaxed mb-8 2xl:mb-12">
